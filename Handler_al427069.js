...
function getCardImageLink(dealtCard){
    ...
    switch(firstCharacter){
  	    case "H":
    	    return "Card_Images/"+dealtCard.slice(4,dealtCard.length)+"_of_hearts.png";
        case "D":
    	    return "Card_Images/"+dealtCard.slice(4,dealtCard.length)+"_of_diamonds.png";
        case "C":
    	    return "Card_Images/"+dealtCard.slice(4,dealtCard.length)+"_of_clubs.png";
        case "S":
    	    return "Card_Images/"+dealtCard.slice(4,dealtCard.length)+"_of_spades.png";
    }
}
...
function audioPlay(task){
    ...
    if(task=="Final Result"){
        audio.src="./Sounds/FinalResultSound.mp3";
    }
    if(task=="Shuffling"){
        audio.src="./Sounds/ShufflingCards.mp3";
    }
    audio.play();
}
...
function appearGameRulesWindow(e){
    ...
    if(e.target.id=="btnBlackJackRules1"){
        ...
        document.getElementById("imgBlackJackRules").setAttribute("src","Other_Images/GameRule_CARDVALUES.png");
    }
...
function gameRuleSetter(e){
    switch(e.target.id){
        case "btnCardValues":
            ...
            break;
        case "btnPlayersTurn":
            document.getElementById("imgBlackJackRules").setAttribute("src","Other_Images/GameRule_PLAYERSTURN.png");
            break;
        case "btnComputersTurn":
            document.getElementById("imgBlackJackRules").setAttribute("src","Other_Images/GameRule_COMPUTERSTURN.png");
            break;
        case "btnWinnerSelection":
            document.getElementById("imgBlackJackRules").setAttribute("src","Other_Images/GameRule_WINNERSELECTION.png");
            break;
    }
}
...
function appearIntroPage(e){
    ...
    if(e.target.id=="btnClose"){
        document.getElementById("divBlackJackRulesPage").style.display="none";
        document.getElementById("divIntroPage").style.display="block";
    }
